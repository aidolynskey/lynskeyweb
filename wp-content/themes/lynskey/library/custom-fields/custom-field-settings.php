...
define('WPTUTS_PAGE_BASENAME', 'custom-fields');
...
require_once('custom-field-options.php');
...
function wptuts_get_settings() {
    ...
    $output['wptuts_page_title'] 		= __( 'Header and Footer Fields','wptuts_textdomain');
...
function wptuts_add_menu(){
    ...
    $wptuts_settings_page = add_theme_page(__('Header and Footer Fields'), __('Header and Footer Fields','wptuts_textdomain'), 'manage_options', WPTUTS_PAGE_BASENAME, 'wptuts_settings_page_fn');
    // contextual help
