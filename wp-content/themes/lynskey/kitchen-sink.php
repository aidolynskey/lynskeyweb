...
get_header(); ?>
<div class="row">
	<div class="small-100 large-100 columns" role="main">
	...
	<?php while (have_posts()) : the_post(); ?>
		<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
				...
				<fieldset>
					...
					<div class="row">
						<div class="large-100 columns">
							...
							<input type="text" placeholder="large-100.columns">
						</div>
					</div>
					...
					<div class="row">
						<div class="large-25 columns">
							<label>Input Label</label>
							<input type="text" placeholder="large-25.columns">
						</div>
						<div class="large-25 columns">
							<label>Input Label</label>
							<input type="text" placeholder="large-25.columns">
					...
					<div class="row">
						<div class="large-100 columns">
							...
							<textarea placeholder="small-100.columns"></textarea>
						</div>
					</div>
			...
			<div class="radius progress success large-75"><span class="meter" style="width: 80%"></span></div>
			...
			<div class="row">
				<div class="large-25 columns end">
					<ul class="side-nav">
